/**
 * ============================================================================
 * REDDOT WORKSTATION OS &bull; ELECTRON MAIN PROCESS (V2.4)
 * Windows Startup Integration, System Tray, Hardware Metrics & Desktop Layer
 * ============================================================================
 */
...
function createWallpaperWindow() {
  ...
  mainWindow = new BrowserWindow({
    ...
    x: 0,
    y: 0,
    type: 'desktop', // Windows desktop wallpaper layer
    frame: false,
    show: false,
    resizable: false,
    movable: false,
...
function updateTrayMenu() {
  ...
  const contextMenu = Menu.buildFromTemplate([
    { label: '◆ REDDOT Workstation OS v2.4', enabled: false },
    { type: 'separator' },
    {
      label: '👥 Team & ID Management',
      click: () => {
    ...
    {
      label: '🔒 Security & Private DB Hub',
      click: () => {
        mainWindow?.webContents.send('open-tab', 'database');
        mainWindow?.focus();
      }
    },
    { type: 'separator' },
